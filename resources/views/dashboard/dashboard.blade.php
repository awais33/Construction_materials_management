                        ...
                        <div class="card bg-primary mini-stat position-relative">
                            <div class="card-body">
                                <div class="mini-stat-desc">
                                    <h6 class="text-uppercase verti-label text-white-50">
                                        Orders
                                    </h6>
                                    <div class="text-white">
                                        <h6 class="text-uppercase mt-0 text-white-50">
                                            Orders
                                        </h6>
                                        <h3 class="mb-3 mt-0">
                                            1,587
                                        ...
                                        <div class="">
                                            ...
                                            <div class="mini-stat-icon">
                                                <i
                                                    class="mdi mdi-cube-outline display-2"
                                                ></i>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div
                                    class="card bg-primary mini-stat position-relative"
                                >
                                    <div class="card-body">
                                        <div class="mini-stat-desc">
                                            <h6
                                                class="text-uppercase verti-label text-white-50"
                                            >
                                                Revenue
                                            </h6>
                                            <div class="text-white">
                                                <h6
                                                    class="text-uppercase mt-0 text-white-50"
                                                >
                                                    Revenue
                                                </h6>
                                                <h3 class="mb-3 mt-0">
                                            ...
                                            <div class="mini-stat-icon">
                                                <i
                                                    class="mdi mdi-buffer display-2"
                                                ></i>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div class="card-body">
                                        <div class="mini-stat-desc">
                                            ...
                                            <div class="mini-stat-icon">
                                                <i
                                                    class="mdi mdi-tag-text-outline display-2"
                                                ></i>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div class="card-body">
                                        <div class="mini-stat-desc">
                                            ...
                                            <div class="mini-stat-icon">
                                                <i
                                                    class="mdi mdi-briefcase-check display-2"
                                                ></i>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            >
                                                ...
                                                <div
                                                    ...
                                                    class="dashboard-charts morris-charts"
                                                ></div>
                                            </div>
                                            <div class="col-xl-4">
                                                <h4
                                        ...
                                        <div class="inbox-wid">
                                            <a href="#" class="text-dark"
                                                ><div class="inbox-item">
                                                    <div
                                                        class="inbox-item-img float-left mr-3"
                                                    >
                                                        <img
                                                    ...
                                                    <h6
                                                        class="inbox-item-author mt-0 mb-1"
                                                    >
                                                        Irene
                                                    </h6>
                                                    <p
                                                        class="inbox-item-text text-muted mb-0"
                                                    >
                                                        Hey! there I'm
                                                        available...
                                                    </p>
                                                    <p
                                                        class="inbox-item-date text-muted"
                                                    >
                                                        13:40 PM
                                                    </p>
                                                </div></a
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <ul
                                                class="nav nav-pills nav-justified recent-activity-tab mb-4"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <span
                                                                    class="peity-donut"
                                                                    data-peity='{ "fill": ["#ffe082", "#f2f2f2"], "innerRadius": 20, "radius": 32 }'
                                                                    data-width="54"
                                                                    data-height="54"
                                                                    >9,4</span
                                                                >
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div
                                            class="table-responsive order-table"
                                        >
                                            <table
                                                class="table table-hover mb-0"
                                            >
